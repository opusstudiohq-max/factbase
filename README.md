...
```text
                                                                   user
void scan                                                      0.001281
20k facts: export: 2973KB                                      0.837578
20k facts: import: 2973KB                                      0.947515
50k facts: read                                                0.000419
50k facts: read in txn                                         0.002462
50k facts: insert                                              0.000284
50k facts: insert in txn                                       0.000197
50k facts: modify                                              1.042565
50k facts: modify in txn                                       2.626462
12k facts: large query: match 3k                              13.883751
12k facts: large query: match 3k in txn                       19.472748
12k facts: large query: match zero                            14.654429
12k facts: large query: match zero in txn                     20.253510
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-09-16 at 00:26,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/opusstudiohq-max/factbase/actions/runs/35039874999
